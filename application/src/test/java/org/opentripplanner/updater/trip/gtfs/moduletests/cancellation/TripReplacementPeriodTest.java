...
class TripReplacementPeriodTest implements RealtimeTestConstants {
  ...
  void cancelsScheduledTripOnRouteWhenAbsentFromFeed() {
    ...
    assertThat(env.tripData(TRIP_1_ID).realTimeState()).isEqualTo(RealTimeState.CANCELED);
  }
  ...
  void doesNotCancelTripPresentInFeed() {
    ...
    assertThat(env.tripData(TRIP_1_ID).realTimeState()).isEqualTo(RealTimeState.UPDATED);
  }
  ...
  void doesNotCancelTripDepartingAfterWindowEnd() {
    ...
    assertThat(env.tripData(TRIP_2_ID).realTimeState()).isEqualTo(RealTimeState.SCHEDULED);
  }
  ...
  void doesNotCancelTripOnRouteNotInReplacementPeriods() {
    ...
    assertThat(env.tripData("RouteBTrip").realTimeState()).isEqualTo(RealTimeState.SCHEDULED);
  }
  ...
  void emptyReplacementPeriodsLeavesAllTripsScheduled() {
    ...
    assertThat(env.tripData(TRIP_1_ID).realTimeState()).isEqualTo(RealTimeState.SCHEDULED);
    assertThat(env.tripData(TRIP_2_ID).realTimeState()).isEqualTo(RealTimeState.SCHEDULED);
    assertThat(env.tripData("RouteBTrip").realTimeState()).isEqualTo(RealTimeState.SCHEDULED);
  }
  ...
  void cancelsMultipleAbsentTripsOnSameRoute() {
    ...
    assertThat(envWithThree.tripData("ATrip1").realTimeState()).isEqualTo(RealTimeState.CANCELED);
    assertThat(envWithThree.tripData("ATrip2").realTimeState()).isEqualTo(RealTimeState.CANCELED);
    assertThat(envWithThree.tripData("ATrip3").realTimeState()).isEqualTo(RealTimeState.CANCELED);
  }
  ...
  void partialTripIdMatchByVariantSuffix() {
    ...
    assertThat(lEnv.tripData(staticTripId).realTimeState()).isEqualTo(RealTimeState.UPDATED);
  }
  ...
  void partialTripIdMatchExcludesTripFromCancellation() {
    ...
    assertThat(subwayEnv.tripData(staticTripId).realTimeState()).isEqualTo(RealTimeState.UPDATED);
  }
  ...
  void rewritesUnresolvedScheduledTripOnCoveredRouteAsAdded() {
    ...
    assertThat(added.realTimeState()).isEqualTo(RealTimeState.ADDED);
  }
  ...
  void rewritesTripWithStopPatternDivergenceOnCoveredRouteAsAdded() {
    ...
    assertThat(modified.realTimeState()).isEqualTo(RealTimeState.MODIFIED);
  }
  ...
  void multipleReplacementPeriodsCancelOnEachRoute() {
    ...
    assertThat(env.tripData(TRIP_1_ID).realTimeState()).isEqualTo(RealTimeState.CANCELED);
    assertThat(env.tripData("RouteBTrip").realTimeState()).isEqualTo(RealTimeState.CANCELED);
